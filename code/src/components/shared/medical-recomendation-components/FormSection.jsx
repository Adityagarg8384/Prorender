...
const SubmitButton = () => (
  <button
    type="submit"
    className="px-12 bg-emerald-400 rounded-xl text-xl text-white  max-md:px-2"
  >
    Submit
  </button>
);
function FormSection() {
  ...
  return (
    <form className="flex overflow-hidden flex-col px-8 pt-6 pb-16 bg-cyan-200 bg-opacity-50 max-md:px-5 max-md:pb-24 my-10">
