      ...
      <div className="mb-0 max-w-full w-[1086px] max-md:mb-2.5">
        <div className="flex gap-5 max-md:flex-col">
          ...
          <nav className="flex flex-col ml-5 w-[27%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col items-start self-stretch my-auto text-4xl text-teal-600 max-md:mt-10">
              <h3 className="self-stretch">Quick Links</h3>
              <a href="#" className="mt-11 max-md:mt-10">Home</a>
              <a href="#" className="mt-8">Services</a>
              <a href="#" className="self-stretch mt-8 max-md:mr-2">Dashboard</a>
              <a href="#" className="mt-8">Profile</a>
            </div>
          </nav>
