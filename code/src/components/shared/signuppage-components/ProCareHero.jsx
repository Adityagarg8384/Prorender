  ...
  return (
    <section className="flex flex-col w-[32%] max-md:ml-0 max-md:w-full h-auto">
      <div className="flex flex-col items-start mt-16 text-white max-md:mt-10">
        <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/69dc7918c46cc36d58ab15242bb456368f4c05c3a0eb159237d5df0374a9852a?placeholderIfAbsent=true&apiKey=eb1e27a892cb49d8a25258d2564dfff8" className="object-contain aspect-square w-[79px]" alt="ProCare logo" />
